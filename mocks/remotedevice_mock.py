...
conn.start_log_stream_from_latest_restart("/var/opt/htm/log", "DeviceServiceMonitor.log", marker)

time.sleep(5)

conn.validate_in_logs("Ignition monitor initialized successfully.")
