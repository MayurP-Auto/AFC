...
class TestDeviceServiceMonitor:
    ...
    def test_device_service_monitor_started_ntp_client(self, remote_conn):
        ...
        assert remote_conn.validate_in_logs("[ntpclient] Application started, pid: 2058"), \
    ...
    def test_device_service_monitor_started_user_interface(self, remote_conn):
        ...
        assert remote_conn.validate_in_logs("[UserInterface] Application started, pid: 2053"), \
    ...
    def test_device_service_monitor_started_validator(self, remote_conn):
        ...
        assert remote_conn.validate_in_logs("[Validator] Application started, pid: 2055"), \
    ...
    def test_device_service_monitor_started_local_support_function(self, remote_conn):
        ...
        assert remote_conn.validate_in_logs("[LocalSupportFunction] Application started, pid: 2057"), \
    ...
    def test_device_service_monitor_started_heartbeat360(self, remote_conn):
        ...
        assert remote_conn.validate_in_logs("[Heartbeat360Client] Application started, pid: 2056"), \
    ...
    def test_device_service_monitor_started_update_handler(self, remote_conn):
        ...
        assert remote_conn.validate_in_logs("[UpdateHandler] Application started, pid: 2054"), \
